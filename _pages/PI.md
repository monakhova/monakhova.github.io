...
<div class="post">
    <div class="profile float-{%- if page.profile.align == 'left' -%}left{%- else -%}right{%- endif -%}">
      ...
      <p><b>Assistant Professor</b> <br> <a href='https://www.cs.cornell.edu/'>Department of Computer Science</a> <br> <a href ='https://www.engineering.cornell.edu/ece/'> ECE Field Member </a><br><a href = 'https://www.cam.cornell.edu/cam'>Applied Mathematics Field Member</a> <br> Cornell University</p>
	  </header>
